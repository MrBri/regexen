describe("your regexes", function(){
  ...
  it("should filter usernames", function(){
    ...
    var regex = /^[a-zA-Z][a-zA-Z\-\_\s]{3,20}$/;
  ...
  it("should detect nearby words", function(){
    ...
    var containsNearbyWords = function(haystack, needle){
      ...
      var partialRegex = /\W+(?:\w+\W+){1,3}?/;
      var bees = /\b/;
      var regex = new RegExp(bees.source + needle + partialRegex.source + needle + bees.source);
      var matchArray = haystack.match(regex);
    ...
    var tests = [
      ...
      ["we like a regex because regexof es", "regex", false],
